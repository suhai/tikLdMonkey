    ...
    return (
      <div className='homepage'>
        ...
        <section className="homepage-bottom">
          <div>
            <span>
              <p className="lorem">Note: Any non-English text on this site is gibberish, taken from Lorem Ipsum, and serving only as a temporary placeholder</p>
